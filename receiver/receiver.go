...
func Collector(w http.ResponseWriter, r *http.Request) {
	...
	var content = &Ivent{}
	err := json.NewDecoder(io.LimitReader(r.Body, 1000)).Decode(&content)
	if err != nil {
...
var (
	NWorkers = flag.Int("n", 10000, "The number of workers to start")
...
func server() {
	...
	if err := http.ListenAndServe(*HTTPAddr, nil); err != nil {
		// TODO if server doesn't work you should quit - if server is only responsibility then even panic
